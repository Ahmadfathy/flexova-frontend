...
/** Five-states signal for the BOM template list (`?mock=loading|empty|error|no_results|offline`),
 * mirroring `useMoList` — templates are read live from `useMfgBomTemplates`, this hook only
