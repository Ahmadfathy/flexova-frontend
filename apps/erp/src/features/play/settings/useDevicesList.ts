...
/** Five-states signal for the devices list (`?mock=loading|empty|error|no_results|offline`),
 * mirroring `useBomList`/`useDeviceTypesList` — devices are read live from `usePlayDevices`,
