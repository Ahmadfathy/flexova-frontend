import { getActiveTheme, getCatalog } from "@/lib/core/mock-bff";
...
export default async function HomePage() {
  const [activeTheme, catalog] = await Promise.all([getActiveTheme(), getCatalog()]);
  ...
  return <HomeLayout storeName="متجر النيل" featured={catalog} />;
}
