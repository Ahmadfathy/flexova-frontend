...
export const MENU: MenuItem[] = [
  ...
  },
  {
    ...
    group: "sector",
    order: 12,
    moduleFlag: "sector.wholesale",
    permission: "sales.order.view",
    subItems: [
      { key: "wh_orders",     route: "/wholesale/orders" },
      { key: "wh_deliveries", route: "/wholesale/deliveries" },
      { key: "wh_routes",     route: "/wholesale/routes" },
  ...
  },
  {
    ...
    group: "sector",
    order: 14,
    moduleFlag: "projects.enabled",
    permission: "projects.project.view",
    subItems: [
      { key: "prj_billing",    route: "/projects/billing" },
      { key: "prj_time",       route: "/time" },
      { key: "prj_approvals",  route: "/time/approvals" },
    ],
  },
  {
    key: "healthcare",
    ...
    group: "sector",
    order: 15,
    moduleFlag: "healthcare",
    permission: "healthcare.today.view",
    subItems: [
      { key: "hc_today",     route: "/healthcare/today" },
      { key: "hc_patients",  route: "/healthcare/patients" },
